<script lang="ts">
    ...
    const cards: Card[] = [
        ...
        {id: 3, title: "Наружная отделка фасада", desc: "Виниловый, металлический и фиброцементный фасад — аккуратный монтаж по технологии.", icon: hammer, type: "black"},
    ...
    <div data-services-right="desktop" class="hidden md:mt-6 md:grid md:grid-cols-2 lg:mt-0 lg:h-full">
        ...
        <div>
            ...
            <div class={`w-[300px] h-[340px] flex justify-center items-center flex-col mx-auto lg:px-4 xl:w-auto 2xl:h-[440px] service-card`}>
                ...
                <button class="w-full" onclick={() => navigateToHash("#contacts")}>
                    <Button
                            text="Связаться"
                            type="button"
                    />
